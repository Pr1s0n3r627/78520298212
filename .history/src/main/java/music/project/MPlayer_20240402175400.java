...
public class MPlayer extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        vbox.getChildren().addAll(currentPlayingLabel, nextSongsLabel, hbox);
        root.setCenter(vbox);
...
public class MPlayer extends Application {
    ...
    private void playSong(File songFile) {
        ...
        musicSlider.valueProperty().bindBidirectional(mediaPlayer.currentTimeProperty().divide(1000));
    }
