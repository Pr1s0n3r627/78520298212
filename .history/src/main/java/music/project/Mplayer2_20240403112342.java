 ...
 * Image defaultAlbumCover = new
 * Image(getClass().getResourceAsStream("default_album_cover.jpg"));
 ...
 * 
 * controlButtonsBox.getChildren().addAll(prevButton, playPauseButton,
 * nextButton);
 ...
 * prevButton.setOnAction(e -> playPreviousSong());
 * 
 * bottomControls.getChildren().addAll(titleLabel, artistLabel, seekSlider,
 * controlButtonsBox);
 ...
 * });
 * 
 * mediaPlayer.currentTimeProperty().addListener((observable, oldValue,
 * newValue) -> {
