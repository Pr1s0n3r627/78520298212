...
public class MPlayer2 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        bottomControls.getChildren().add(controlButtonsBox);
    ...
    private VBox createBottomControls() {
        ...
        updateSongInfo(); // Update song information initially
        ...
        bottomControls.getChildren().addAll(titleLabel, artistLabel, seekSlider, controlButtonsBox);
    ...
    private void updateSongInfo() {
        if (currentSongIndex >= 0 && currentSongIndex < songQueue.size()) {
            File currentSong = songQueue.get(currentSongIndex);
            Metadata metadata = this.metadata.get(currentSong);
            if (metadata != null) {
...
public class MPlayer2 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        BorderPane root = new BorderPane();
        root.setStyle("-fx-background-color: #000000;"); // Set background color to AMOLED black
        root.setPadding(new Insets(20));
        ...
        Scene scene = new Scene(root, 450, 800); // Set window size to 450 x 800
        scene.getStylesheets().add(getClass().getResource("style.css").toExternalForm()); // Load CSS for styling
        primaryStage.setScene(scene);
        primaryStage.setTitle("MPlayer2");
        primaryStage.show();
    }
    ...
    private VBox createBottomControls() {
        ...
        titleLabel = new Label("");
        titleLabel.setStyle("-fx-font-size: 20px; -fx-text-fill: white;"); // Set text color to white
        artistLabel = new Label("");
        artistLabel.setStyle("-fx-font-size: 18px; -fx-text-fill: #B3B3B3;"); // Set text color to light gray
